...
helyxApp.config(function ($httpProvider) {
...
helyxApp.factory('UsersApiService', function ($rootScope, $q, $http, Globals) {
	var UsersApiService = {};
...
helyxApp.controller('LoginCtrl', function ($rootScope, $scope, $state, ngDialog, UsersApiService) {
...
helyxApp.controller('SignUpCtrl', function ($scope, $state, UsersApiService) {
...
helyxApp.controller('ResetPasswordCtrl', function ($scope, $state, UsersApiService) {
...
helyxApp.controller('ChangePasswordCtrl', function ($scope, $state, $stateParams, UsersApiService) {
...
helyxApp.controller('LogoutCtrl', function ($scope) {
